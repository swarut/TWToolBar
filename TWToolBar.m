...
- (UIButton*)buttonWithTitle:(NSString*)title withImage:(NSString*)imageName
  ...
  switch (self.buttonStyle) {
    case TWToolBarPlainButtonStyle:
      button.backgroundColor = [UIColor colorWithRed:99.0/255.0 green:199.0/255.0 blue:239.0/255.0 alpha:1.0];
    ...
    case TWToolBarFullButtonStyle:
    {
      // Force a frame first, so that the image is rendered right above the text.
      button.frame = CGRectMake(0, 0, 100, 100);
      button.backgroundColor = [UIColor colorWithRed:94.0/255.0 green:102.0/255.0 blue:109.0/255.0 alpha:1.0];
      [button setTitle:title forState:UIControlStateNormal];
      [button setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
      [button setTitleColor:[UIColor colorWithRed:60.0/255.0 green:186.0/255.0 blue:235.0/255.0 alpha:1.0] forState:UIControlStateHighlighted];
      
      [button setImage:[UIImage imageNamed:imageName] forState:UIControlStateNormal];
      [button setImage:[UIImage imageNamed:highlightedImageName] forState:UIControlStateHighlighted];
      [button setNeedsDisplay];
      
      // Adjust the image and title position.
      CGSize imageSize = button.imageView.frame.size;
      CGSize titleSize = button.titleLabel.frame.size;
      button.titleEdgeInsets = UIEdgeInsetsMake(
        0.0, - imageSize.width, - (imageSize.height + buttonSpacing), 0.0);
      button.imageEdgeInsets = UIEdgeInsetsMake(
        - (titleSize.height + buttonSpacing), 0.0, 0.0, - titleSize.width);
