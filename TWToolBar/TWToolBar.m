...
- (instancetype)initWithFrame:(CGRect)frame andViews:(NSArray *)views
    ...
    if (self) {
        ...
        self.trailingSpace    = leadingSpace;
        self.spaceBetweenItem = spaceBetweenItem;
...
+ (TWToolBar*)toolBarWithViews:(NSArray *)views
    ...
    TWToolBar* toolBar = [[TWToolBar alloc] initWithFrame:frame
                                                 andViews:views
                                          andLeadingSpace:leadingSpace
                                      andSpaceBetweenItem:spaceBetweenItem];
